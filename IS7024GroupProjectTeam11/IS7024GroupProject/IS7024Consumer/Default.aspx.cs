...
public partial class _Default : System.Web.UI.Page
{
    ...
    {
        HttpWebRequest request = CreateWebRequest(@"https://maps.googleapis.com/maps/api/place/autocomplete/xml?key=AIzaSyDA6ZVUddbsUo-mSdlwKCLk1xliopMqZvc&input=" + Address);
        string AutoComplete = "";
        using (WebResponse response = request.GetResponse())
        {
            using (StreamReader rd = new StreamReader(response.GetResponseStream()))
    ...
    {
        HttpWebRequest request = CreateWebRequest(@"https://maps.googleapis.com/maps/api/place/details/xml?key=AIzaSyDA6ZVUddbsUo-mSdlwKCLk1xliopMqZvc&placeid=" + PlaceID);
        string PlaceDetails = "";
        using (WebResponse response = request.GetResponse())
        {
            using (StreamReader rd = new StreamReader(response.GetResponseStream()))
